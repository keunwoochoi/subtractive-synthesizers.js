...
export const PRESETS = {
  "analog-bass": { label: "Analog bass", group: "bass",
    ...
    params: { shape: W.saw, filterKind: F.ladder, unison: 2, detuneCents: 6, subLevel: 0.6, cutoffHz: 420, resonance: 0.28, drive: 1.6, envAmount: 2200, keyTrack: 0.25, ampDecay: 0.3, ampSustain: 0.6, ampRelease: 0.14, fltDecay: 0.22, fltSustain: 0.12, velToCutoff: 1800, reverbMix: 0.05, reverbSize: 0.35, gain: 0.435 , stereoWidth: 0.2 } },
  ...
  "kick-bass": { label: "Kick bass", group: "bass",
    ...
    params: { shape: W.tri, filterKind: F.ladder, unison: 1, subLevel: 0.7,
  ...
  "sub-bass": { label: "Sub bass", group: "bass",
    ...
    params: { shape: W.tri, filterKind: F.ladder, unison: 1, subLevel: 0.85, cutoffHz: 180, resonance: 0.05, drive: 1.0, envAmount: 300, keyTrack: 0.1, ampAttack: 0.008, ampDecay: 0.4, ampSustain: 0.85, ampRelease: 0.2, fltSustain: 0.6, velToCutoff: 400, gain: 0.264 , stereoWidth: 0.0 } },
  "growl-bass": { label: "Growl bass", group: "bass",
    blurb: "Fast filter wobble. Aggressive and moving.",
    params: { shape: W.saw, filterKind: F.ladder, unison: 2, detuneCents: 14, subLevel: 0.4, cutoffHz: 300, resonance: 0.7, drive: 3.0, envAmount: 1800, lfoRate: 7.5, lfoToCutoff: 1400, ampSustain: 0.85, ampRelease: 0.1, fltDecay: 0.25, fltSustain: 0.4, velToCutoff: 1600, gain: 0.289 , stereoWidth: 0.35 } },
  "pluck-bass": { label: "Pluck bass", group: "bass",
    blurb: "No sustain at all. Percussive and dry.",
    params: { shape: W.saw, filterKind: F.ladder, unison: 1, subLevel: 0.45, cutoffHz: 500, resonance: 0.55, drive: 1.5, envAmount: 3000, ampDecay: 0.2, ampSustain: 0, ampRelease: 0.09, fltDecay: 0.1, fltSustain: 0, velToCutoff: 2400, gain: 0.85 , stereoWidth: 0.2 } },
  "wide-bass": { label: "Wide bass", group: "bass",
    blurb: "Heavily detuned pair, slow sweep. Wide and unstable.",
    params: { shape: W.saw, filterKind: F.lp, unison: 2, detuneCents: 34, subLevel: 0.3, cutoffHz: 480, resonance: 0.4, drive: 1.4, envAmount: 900, lfoRate: 0.22, lfoToCutoff: 500, ampAttack: 0.02, ampSustain: 0.9, ampRelease: 0.3, fltSustain: 0.7, velToCutoff: 900, gain: 0.203 , stereoWidth: 0.85 } },
  "square-lead": { label: "Square lead", group: "lead",
    blurb: "Hollow and vocal. The oldest lead there is.",
    params: { shape: W.pulse, filterKind: F.ladder, unison: 1, pulseWidth: 0.5, subLevel: 0.2, cutoffHz: 1900, resonance: 0.25, envAmount: 1600, keyTrack: 0.6, ampAttack: 0.008, ampSustain: 0.85, ampRelease: 0.18, fltSustain: 0.5, lfoRate: 5.4, lfoToPitch: 7, reverbMix: 0.22, delayMix: 0.2, gain: 0.16 } },
  "saw-lead": { label: "Saw lead", group: "lead",
    blurb: "Bright and direct. Cuts without volume.",
    params: { shape: W.saw, filterKind: F.ladder, unison: 2, detuneCents: 9, subLevel: 0.2, cutoffHz: 2200, resonance: 0.35, drive: 1.5, envAmount: 2000, keyTrack: 0.55, glide: 0.03, ampAttack: 0.01, ampSustain: 0.85, ampRelease: 0.2, fltSustain: 0.5, lfoRate: 5.2, lfoToPitch: 8, chorusMix: 0.3, delayMix: 0.28, reverbMix: 0.3, gain: 0.343 } },
  ...
  "soft-lead": { label: "Soft lead", group: "lead",
    ...
    params: { shape: W.tri, filterKind: F.lp, unison: 2, detuneCents: 5, subLevel: 0.15, cutoffHz: 2400, resonance: 0.12, drive: 1.0, envAmount: 900, keyTrack: 0.5, ampAttack: 0.06, ampSustain: 0.9, ampRelease: 0.3, fltAttack: 0.05, fltSustain: 0.7, lfoRate: 4.6, lfoToPitch: 6, chorusMix: 0.4, reverbMix: 0.4, gain: 0.184 } },
  "buzz-lead": { label: "Buzz lead", group: "lead",
    blurb: "Narrow pulse, hard drive. Nasal and rude.",
    params: { shape: W.pulse, filterKind: F.diode, unison: 2, detuneCents: 12, pulseWidth: 0.16, subLevel: 0.1, cutoffHz: 1500, resonance: 0.6, drive: 3.2, envAmount: 2400, keyTrack: 0.5, ampSustain: 0.85, ampRelease: 0.15, fltDecay: 0.25, fltSustain: 0.45, delayMix: 0.25, gain: 0.159 } },
  "pwm-lead": { label: "PWM lead", group: "lead",
    blurb: "Pulse width breathing under the note.",
    params: { shape: W.pulse, filterKind: F.ladder, unison: 2, detuneCents: 7, subLevel: 0.2, cutoffHz: 2000, resonance: 0.28, envAmount: 1400, keyTrack: 0.55, ampAttack: 0.015, ampSustain: 0.88, ampRelease: 0.22, fltSustain: 0.6, lfoRate: 0.9, lfoToPwm: 0.34, chorusMix: 0.35, reverbMix: 0.28, gain: 0.227 } },
  "whistle-lead": { label: "Whistle lead", group: "lead",
    blurb: "Almost a sine, with vibrato. Sits on top of everything.",
    params: { shape: W.tri, filterKind: F.lp, unison: 1, subLevel: 0.05, cutoffHz: 3200, resonance: 0.08, drive: 1.0, envAmount: 400, keyTrack: 0.7, ampAttack: 0.05, ampSustain: 0.9, ampRelease: 0.25, fltSustain: 0.8, lfoRate: 5.8, lfoToPitch: 16, reverbMix: 0.45, delayMix: 0.2, gain: 0.126 } },
  ...
  "string-pad": { label: "String pad", group: "pad",
    ...
    params: { shape: W.saw, filterKind: F.lp, unison: 5, detuneCents: 22, subLevel: 0.15, cutoffHz: 1500, resonance: 0.12, drive: 1.0, envAmount: 700, keyTrack: 0.5, ampAttack: 0.35, ampSustain: 0.85, ampRelease: 1.0, fltAttack: 0.4, fltSustain: 0.7, chorusMix: 0.95, chorusRate: 0.55, chorusDepth: 5.5, reverbMix: 0.5, reverbSize: 0.8, gain: 0.306 , stereoWidth: 0.95 } },
  ...
  "sweep-pad": { label: "Sweep pad", group: "pad",
    ...
    params: { shape: W.saw, filterKind: F.ladder, unison: 3, detuneCents: 17, subLevel: 0.25, cutoffHz: 400, resonance: 0.5, drive: 1.3, envAmount: 900, ampAttack: 0.6, ampSustain: 0.85, ampRelease: 1.4, fltAttack: 0.8, fltSustain: 0.6, lfoRate: 0.12, lfoToCutoff: 2200, chorusMix: 0.5, reverbMix: 0.55, reverbSize: 0.9, gain: 0.459 } },
  "glass-pad": { label: "Glass pad", group: "pad",
    blurb: "Highpassed and thin. Sits above a mix, never in it.",
    params: { shape: W.saw, filterKind: F.hp, unison: 4, detuneCents: 16, subLevel: 0, cutoffHz: 900, resonance: 0.35, drive: 1.1, envAmount: 600, keyTrack: 0.6, ampAttack: 0.4, ampSustain: 0.8, ampRelease: 1.1, fltAttack: 0.5, fltSustain: 0.6, chorusMix: 0.6, reverbMix: 0.65, reverbSize: 0.9, reverbDamp: 9000, gain: 0.663 , stereoWidth: 0.85 } },
  "dark-pad": { label: "Dark pad", group: "pad",
    blurb: "Everything above the fundamental removed. Ominous.",
    params: { shape: W.saw, filterKind: F.ladder, unison: 3, detuneCents: 21, subLevel: 0.5, cutoffHz: 260, resonance: 0.22, drive: 1.4, envAmount: 500, keyTrack: 0.3, ampAttack: 0.7, ampSustain: 0.85, ampRelease: 1.6, fltAttack: 0.9, fltSustain: 0.5, chorusMix: 0.4, reverbMix: 0.6, reverbSize: 0.95, reverbDamp: 2200, gain: 0.252 } },
  ...
  "rain": { label: "Rain", group: "pad",
    ...
    params: { shape: W.tri, filterKind: F.bp, unison: 1, subLevel: 0, noiseLevel: 0.9, cutoffHz: 2200, resonance: 0.72, envAmount: 600, keyTrack: 0.8, ampAttack: 0.5, ampSustain: 0.7, ampRelease: 1.2, fltSustain: 0.7, lfoRate: 0.45, lfoToCutoff: 1800, reverbMix: 0.6, delayMix: 0.3, delayTime: 0.4, gain: 0.471 , stereoWidth: 0.7 } },
  ...
  "wow-pluck": { label: "Wow pluck", group: "pluck",
    ...
    params: { shape: W.saw, filterKind: F.ladder, unison: 2, detuneCents: 7,
  ...
  "bell-pluck": { label: "Bell pluck", group: "pluck",
    ...
    params: { shape: W.pulse, filterKind: F.bp, unison: 2, detuneCents: 8, subLevel: 0.1, cutoffHz: 1600, resonance: 0.55, drive: 1.1, envAmount: 2600, keyTrack: 0.8, ampDecay: 0.5, ampSustain: 0, ampRelease: 0.3, fltDecay: 0.2, fltSustain: 0, reverbMix: 0.55, reverbSize: 0.8, delayMix: 0.3, delayTime: 0.33, gain: 0.619 } },
  "e-piano": { label: "Electric keys", group: "pluck",
    blurb: "Soft attack, woody body, medium decay.",
    params: { shape: W.tri, filterKind: F.ladder, unison: 2, detuneCents: 4, subLevel: 0.35, cutoffHz: 1300, resonance: 0.2, drive: 1.5, envAmount: 1600, keyTrack: 0.5, ampAttack: 0.004, ampDecay: 0.8, ampSustain: 0.25, ampRelease: 0.3, fltDecay: 0.5, fltSustain: 0.15, velToCutoff: 2600, chorusMix: 0.3, reverbMix: 0.25, gain: 0.381 } },
  "clav": { label: "Clav", group: "pluck",
    blurb: "Narrow pulse, high resonance, gone instantly.",
    params: { shape: W.pulse, filterKind: F.bp, unison: 1, pulseWidth: 0.22, subLevel: 0.15, cutoffHz: 1600, resonance: 0.62, drive: 1.8, envAmount: 2600, keyTrack: 0.6, ampDecay: 0.22, ampSustain: 0.05, ampRelease: 0.1, fltDecay: 0.12, fltSustain: 0.1, velToCutoff: 2800, gain: 0.783 } },
  "mallet": { label: "Mallet", group: "pluck",
    blurb: "Struck and wooden. Almost no harmonics after the hit.",
    params: { shape: W.tri, filterKind: F.lp, unison: 1, subLevel: 0.2, cutoffHz: 1400, resonance: 0.3, drive: 1.0, envAmount: 3000, keyTrack: 0.7, ampAttack: 0.001, ampDecay: 0.35, ampSustain: 0, ampRelease: 0.15, fltDecay: 0.07, fltSustain: 0, velToCutoff: 2600, reverbMix: 0.3, gain: 0.556 } },
  ...
  "hoover": { label: "Hoover", group: "brass",
    ...
    params: { shape: W.pulse, filterKind: F.ladder, unison: 5, detuneCents: 44, pulseWidth: 0.28, subLevel: 0.35, cutoffHz: 320, resonance: 0.72, drive: 2.6, envAmount: 5200, glide: 0.12, ampAttack: 0.01, ampSustain: 0.85, ampRelease: 0.25, fltDecay: 0.9, fltSustain: 0.18, lfoRate: 0.6, lfoToPwm: 0.2, reverbMix: 0.35, delayMix: 0.2, gain: 0.14 , stereoWidth: 0.8 } },
  "horn-swell": { label: "Horn swell", group: "brass",
    blurb: "Slow in, slow out. Wants to be held.",
    params: { shape: W.saw, filterKind: F.lp, unison: 4, detuneCents: 12, subLevel: 0.3, cutoffHz: 700, resonance: 0.25, drive: 1.4, envAmount: 2000, ampAttack: 0.3, ampSustain: 0.9, ampRelease: 0.6, fltAttack: 0.35, fltSustain: 0.7, lfoRate: 3.8, lfoToPitch: 4, chorusMix: 0.3, reverbMix: 0.45, reverbSize: 0.8, gain: 0.149 } },
