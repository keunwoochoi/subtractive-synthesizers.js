...
Everything above the fundamental removed. Ominous. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Everything above the fundamental removed. Ominous.” character rather than smoothing it into a general-purpose pad sound; a broader but less recognizable version loses.
