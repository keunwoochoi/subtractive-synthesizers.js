...
Bright and direct. Cuts without volume. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Bright and direct. Cuts without volume.” character rather than smoothing it into a general-purpose lead sound; a broader but less recognizable version loses.
