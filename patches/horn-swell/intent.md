...
Slow in, slow out. Wants to be held. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Slow in, slow out. Wants to be held.” character rather than smoothing it into a general-purpose brass sound; a broader but less recognizable version loses.
