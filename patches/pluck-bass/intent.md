...
No sustain at all. Percussive and dry. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “No sustain at all. Percussive and dry.” character rather than smoothing it into a general-purpose bass sound; a broader but less recognizable version loses.
