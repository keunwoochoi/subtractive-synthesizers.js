...
Triangle through a gentle filter. Flute-ish. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Triangle through a gentle filter. Flute-ish.” character rather than smoothing it into a general-purpose lead sound; a broader but less recognizable version loses.
