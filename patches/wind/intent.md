...
No oscillator at all — pink noise through a slow, resonant sweep. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “No oscillator at all — pink noise through a slow, resonant sweep.” character rather than smoothing it into a general-purpose pad sound; a broader but less recognizable version loses.
