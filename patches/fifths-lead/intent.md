...
Melodic lines that need a clear foreground identity in the current patch bank.

## In words

Two voices a fifth apart. Instantly bigger than one note. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Two voices a fifth apart. Instantly bigger than one note.” character rather than smoothing it into a general-purpose lead sound; a broader but less recognizable version loses.
