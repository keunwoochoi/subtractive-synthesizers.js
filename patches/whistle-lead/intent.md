...
Almost a sine, with vibrato. Sits on top of everything. This wording is reconstructed from the shipped patch metadata. The current implementation is the retrospective baseline: it must remain stable, audible, and distinguishable from every other exported preset.

## The one committed target

Preserve the specific “Almost a sine, with vibrato. Sits on top of everything.” character rather than smoothing it into a general-purpose lead sound; a broader but less recognizable version loses.
